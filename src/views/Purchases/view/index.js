...
const PurchasePreview = () => {
  ...
  return store.purchase !== null && store.purchase !== undefined ? (
    ...
    <Alert color='danger'>
      <h4 className='alert-heading'>Purchase not found</h4>
      <div className='alert-body'>
        Purchase with id: {id} doesn't exist. Check list of all purchases:{' '}
        <Link to='/sales'>Purchase List</Link>
      </div>
    </Alert>
  )
}
