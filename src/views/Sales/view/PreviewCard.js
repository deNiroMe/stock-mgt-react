...
const PreviewCard = ({ invoice, items }) => {
  return invoice !== null ? (
        ...
        <div className='d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0'>
          ...
          <div className='mt-md-0 mt-2'>
            <h4 className='invoice-title'>
              Invoice <span className='invoice-number'># {invoice.reference}</span>
            </h4>
            ...
            <div className='invoice-date-wrapper'>
              <p className='invoice-date-title'>Invoice To:</p>
              <p className='invoice-date'>{invoice.client.name}</p>
            </div>
          </div>
        </div>
        {/* /Header */}
        ...
        <Row className='invoice-sales-total-wrapper'>
          <Col className='mt-md-0 mt-3' md='6' order={{ md: 1, lg: 2 }}>
            <CardText className='mb-0'>
              <span className='fw-bold'>Salesperson:</span> <span className='ms-75'>{invoice.salesPerson.name}</span>
            </CardText>
          </Col>
